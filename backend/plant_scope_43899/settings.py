"""
Django settings for plant_scope_43899 project.
...
ROOT_URLCONF = 'plant_scope_43899.urls'
...
WSGI_APPLICATION = 'plant_scope_43899.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plant_scope_43899 API",
    "DESCRIPTION": "API documentation for plant_scope_43899 App",
    "VERSION": "v1",
}
